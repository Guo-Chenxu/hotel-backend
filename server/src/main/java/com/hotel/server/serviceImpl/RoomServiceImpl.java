    ...
    public Page<Room> conditionPage(PageRoomReq pageRoomReq) {
        return roomMapper.selectPage(new Page<Room>(pageRoomReq.getPage(), pageRoomReq.getPageSize()),
                new LambdaQueryWrapper<Room>()
                        .eq(pageRoomReq.getRoomNo() != null, Room::getNo, pageRoomReq.getRoomNo())
                        .eq(pageRoomReq.getStatus() != null, Room::getStatus, pageRoomReq.getStatus())
                        .eq(StringUtils.isNoneBlank(pageRoomReq.getType()), Room::getType, pageRoomReq.getType())
        );
    }
}
