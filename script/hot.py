...
users = {
    "用户1": {"name": "热测试1", "room": 143},
    "用户2": {"name": "热测试2", "room": 144},
    "用户3": {"name": "热测试3", "room": 145},
    "用户4": {"name": "热测试4", "room": 146},
    "用户5": {"name": "热测试5", "room": 147},
}
...
change(token1, temp=24, status=None)
...
change(token2, temp=25, status=None)
...
change(token3, temp=27, status=None)
...
change(token5, temp=24, status=None)
...
change(token1, temp=28, status=None)

change(token4, temp=28, status=3)
...
change(token5, temp=None, status=2)
...
change(token2, temp=None, status=3)
...
change(token3, temp=None, status=1)
...
change(token4, temp=25, status=2)
...
change(token2, temp=27, status=2)
